...
width_shape = 176 # Image width
height_sape = 208 # Image height
...
pic_path = "/content/dataset/validation/NonDemented/26 (64).jpg"

test_face = cv2.cvtColor(cv2.imread(pic_path), cv2.COLOR_BGR2GRAY)
test_face = cv2.resize(test_face, (208, 176))
