...
'''# Convolution layer 5 => La maxima accuracy amb aquesta capa es del 14%
...
optimizer = Adam(learning_rate=0.01, decay=1e-4 / epochs) # learning_rate=1e-4
...
pic_path = "/content/dataset/validation/VeryMildDemented/02d8aed6-b958-4663-a4f2-9e3a54d6d06c.jpg"

test_face = cv2.cvtColor(cv2.imread(pic_path), cv2.COLOR_BGR2GRAY)
test_face = cv2.resize(test_face, (190, 200))
...
model.save("AlzheimerDetector.h5")
